...
////struct Compare
////{
////	bool operator()(const Pair& tmp1, const Pair& tmp2)
////	{
...
////
////	vector<int> ret;
////	for (int i = 0; i < min((size_t)N,um.size()); i++)
////	{
...
////
////// ====================== 测试框架 ======================
////void run_test(const std::vector<int>& nums, int k, const std::vector<int>& expected,
////    const std::string& test_name) {
////    std::vector<int> nums_copy = nums; // 避免修改原始数据
////    std::vector<int> result = func(nums_copy, k); // 调用你的函数
////
////    // 验证结果大小
////    if (result.size() != expected.size()) {
////        std::cerr << "❌ [" << test_name << "] 失败! "
////            << "结果大小错误: 期望 " << expected.size()
////            << ", 实际 " << result.size() << std::endl;
////        std::cerr << "  输入: ";
////        for (int num : nums) std::cerr << num << " ";
////        std::cerr << ", k=" << k << std::endl;
////        std::cerr << "  期望: ";
////        for (int num : expected) std::cerr << num << " ";
////        std::cerr << "\n  实际: ";
////        for (int num : result) std::cerr << num << " ";
////        std::cerr << std::endl;
////        return;
////    }
////
...
////
////        for (size_t i = 0; i < result.size(); ++i) {
////            if (freq[result[i]] != freq[expected[i]]) {
////                passed = false;
////                break;
////            }
////            // 如果频率相同，但顺序不同，可能也是正确实现（取决于你的排序规则）
////            if (i > 0 && freq[result[i]] == freq[result[i - 1]]) {
////                // 频率相同的元素，检查是否都在期望结果中
...
////    int k = 2;
////    std::vector<int> expected = { 1, 2 }; // 1出现3次，2出现2次
////    run_test(nums, k, expected, "基本功能测试");
////}
////
////// 测试 2: 频率相同的情况（按数值排序）
////void test_same_frequency() {
////    std::vector<int> nums = { 1, 1, 2, 2, 3, 3 };
////    int k = 2;
////    std::vector<int> expected = { 1, 2 }; // 频率相同，按数值升序
////    run_test(nums, k, expected, "频率相同按数值排序");
////}
////
////// 测试 3: k = 1（只取最高频）
////void test_k_equals_1() {
////    std::vector<int> nums = { 4, 1, -1, 2, 1, 4, 4, 4 };
////    int k = 1;
////    std::vector<int> expected = { 4 }; // 4出现4次
////    run_test(nums, k, expected, "k=1 只取最高频");
////}
////
////// 测试 4: k 等于不同元素数量
////void test_k_equals_unique_count() {
////    std::vector<int> nums = { 5, 3, 1, 1, 1, 3, 73, 1 };
////    int k = 3; // 有3个不同元素: 1,3,73
////    std::vector<int> expected = { 1, 3, 73 }; // 1:4次, 3:2次, 73:1次
////    run_test(nums, k, expected, "k=不同元素数量");
////}
////
////// 测试 5: k 大于不同元素数量
////void test_k_greater_than_unique() {
////    std::vector<int> nums = { 1, 2, 3, 4 };
////    int k = 10; // 大于不同元素数量(4)
////    std::vector<int> expected = { 1, 2, 3, 4 }; // 应返回所有元素
////    run_test(nums, k, expected, "k>不同元素数量");
////}
////
////// 测试 6: 负数和零
////void test_negative_and_zero() {
////    std::vector<int> nums = { -1, -1, -2, -2, -2, 0, 0, 0, 0 };
////    int k = 2;
////    std::vector<int> expected = { 0, -2 }; // 0:4次, -2:3次
////    run_test(nums, k, expected, "负数和零");
////}
////
////// 测试 7: 大量重复元素
////void test_many_duplicates() {
////    std::vector<int> nums;
////    for (int i = 0; i < 1000; ++i) nums.push_back(1); // 1000个1
////    for (int i = 0; i < 900; ++i) nums.push_back(2);  // 900个2
////    for (int i = 0; i < 800; ++i) nums.push_back(3);  // 800个3
////    int k = 2;
////    std::vector<int> expected = { 1, 2 };
////    run_test(nums, k, expected, "大量重复元素");
////}
////
////// 测试 8: 空数组
...
////    run_test(nums, k, expected, "单元素数组");
////}
////
////// 测试 10: 所有元素相同
////void test_all_same() {
...
////    run_test(nums, k, expected, "所有元素相同");
////}
////
////// 测试 11: k=0
////void test_k_equals_0() {
////    std::vector<int> nums = { 1, 2, 3, 1, 2, 1 };
////    int k = 0;
////    std::vector<int> expected = {};
////    run_test(nums, k, expected, "k=0");
////}
////
////// 测试 12: 大数据量（性能测试）
...
////    int k = 10;
////    // 不验证具体结果，只测试是否崩溃/超时
////    std::vector<int> result = func(nums, k);
////    std::cout << "✅ [大数据量测试] 通过! (返回了 " << result.size() << " 个元素)" << std::endl;
////}
////
////// 测试 13: 频率相同但需要自定义排序
////void test_custom_order_same_freq() {
////    std::vector<int> nums = { 5, 5, 4, 4, 3, 3, 2, 2, 1, 1 };
////    int k = 3;
////    // 假设你的实现是：频率相同按数值升序
////    std::vector<int> expected = { 1, 2, 3 };
////    run_test(nums, k, expected, "频率相同自定义排序");
////}
////
////// 测试 14: 极端值
...
////    };
////    int k = 2;
////    std::vector<int> expected = { 0, INT_MIN }; // 0出现4次, INT_MIN出现3次
////    run_test(nums, k, expected, "极端值测试");
////}
////
////// 测试 15: 交错出现
////void test_interleaved() {
////    std::vector<int> nums = { 1, 2, 3, 1, 2, 3, 1, 2, 1 };
////    int k = 2;
////    std::vector<int> expected = { 1, 2 }; // 1:4次, 2:3次, 3:2次
////    run_test(nums, k, expected, "交错出现");
////}
////
////// 测试 16: 频率分布不均匀
////void test_skewed_distribution() {
////    std::vector<int> nums;
////    // 1个出现100次
////    for (int i = 0; i < 100; ++i) nums.push_back(1);
////    // 2-10各出现10次
////    for (int num = 2; num <= 10; ++num) {
////        for (int i = 0; i < 10; ++i) nums.push_back(num);
////    }
////    // 11-20各出现1次
...
////
////    int k = 5;
////    std::vector<int> expected = { 1, 2, 3, 4, 5 }; // 1:100次, 2-5:10次
////    run_test(nums, k, expected, "频率分布不均匀");
////}
////
////// 测试 17: 边界情况 - k=1 但有多个相同频率
////void test_k1_multiple_same_freq() {
////    std::vector<int> nums = { 1, 1, 2, 2, 3, 3 };
////    int k = 1;
////    // 有多个元素频率相同，应该返回其中一个
////    // 我们检查返回的元素频率是否正确
////    std::vector<int> result = func(nums, 1);
////    if (result.size() == 1 && (result[0] == 1 || result[0] == 2 || result[0] == 3)) {
////        std::cout << "✅ [k=1多相同频率] 通过! (返回了 " << result[0] << ")" << std::endl;
////    }
////    else {
////        std::cerr << "❌ [k=1多相同频率] 失败! "
////            << "期望返回1/2/3中的一个, 实际返回: ";
////        for (int num : result) std::cerr << num << " ";
////        std::cerr << std::endl;
////    }
...
////    run_test(nums, k, expected, "大K值测试");
////}
////
////// 测试 19: 重复元素但k很小
////void test_small_k_large_duplicates() {
////    std::vector<int> nums;
...
////    }
////    int k = 5;
////    std::vector<int> expected = { 1000, 999, 998, 997, 996 }; // 出现次数最多的5个
////    run_test(nums, k, expected, "小k大重复");
////}
////
////// 测试 20: 随机生成测试
////void test_random() {
...
////
////    // 检查1: 返回数量正确
////    if (result.size() > k || result.size() > 100) { // 100是不同元素的最大可能数量
////        std::cerr << "❌ [随机测试] 失败! 返回数量不合理: " << result.size() << std::endl;
////        return;
////    }
////
////    // 检查2: 没有重复元素
////    std::set<int> result_set(result.begin(), result.end());
////    if (result_set.size() != result.size()) {
////        std::cerr << "❌ [随机测试] 失败! 结果包含重复元素" << std::endl;
////        return;
////    }
////
////    std::cout << "✅ [随机测试] 通过! (返回了 " << result.size() << " 个唯一元素)" << std::endl;
////}
////
////// ====================== 主函数 ======================
////int main() {
...
////    test_k_equals_0();
////    test_large_data();
////    test_custom_order_same_freq();
////    test_extreme_values();
////    test_interleaved();
////    test_skewed_distribution();
////    test_k1_multiple_same_freq();
////    test_large_k();
////    test_small_k_large_duplicates();
////    test_random();
////
////    std::cout << "\n=============== 测试完成 ===============\n" << std::endl;
////    return 0;
...
////    //    if (is_Full() == true)
////    //    {
////    //        Circular_Queue new_Circular_Queue(_size * 2);
////    //        while (is_Empty() != true)
////    //        {
////    //            int tmp;
////    //            de_Queue(tmp);
////    //            new_Circular_Queue.en_Queue(tmp);
////    //        }
////
////    //        _head = new_Circular_Queue._head;
////    //        _tail = new_Circular_Queue._tail;
////    //        _size = _size * 2;
////    //        swap(_arr, new_Circular_Queue._arr);
////    //    }
////    //    return;
////    //}
////
...
////		if (is_Full() == true)
////		{
////			int new_capacity = _size * 2;
////			int* new_arr = new int[new_capacity];
////
////			int sz = (_tail - _head + _size) % _size;
////			for (int i = 0; i < sz; i++)
////			{
////				new_arr[i] = _arr[(_head + i + 1) % _size];
////			}
////
////			_head = 0;
////			_tail = sz;
...
////		{
////			tmp = str.substr(left, string::npos);
////		}
////		else
////		{
...
////class Character
////{
////	Character(int Health, int Attack_Power, int Defense)
////		:_Health(Health)
...
/////**
//// * 匹配带有通配符的字符串
//// * @param pattern 模式字符串，包含普通字符、$和*通配符
//// * @param str 待匹配的字符串
//// * @return 完全匹配返回true，否则返回false
//// */
////bool match(const char* pattern, const char* str) 
////{
////    const char* starPos = NULL;  // 记录最近的*在pattern中的位置
////    const char* strPos = NULL;   // 记录匹配*时字符串的位置
////
////    while (*str) 
////    {
////        if (*pattern == '*') 
////        {
////            // 1. 遇到*通配符，记录位置并尝试匹配空字符串
////            starPos = pattern++;
////            strPos = str;
////        }
////        else if (*pattern == '$') 
...
//#include <iostream>
//
//bool Match(const char* pWild, const char* pStr)
//{
//    const char* pTempWildPtr = pWild;
//    const char* pTempStrPtr = pStr;
//    unsigned int dwCount = 0;
//    unsigned int dwStrLen = (unsigned int)strlen(pStr);
//
//    while ((*pTempWildPtr != '\0') && (*pTempStrPtr != '\0'))
//    {
//        switch (*pTempWildPtr)
//        {
//        case '*':
//            pTempWildPtr = pTempWildPtr + 1;
//            if (*pTempWildPtr == '\0')
//                return true;
//            else
//            {
...
//                {
//                    if (Match(pTempWildPtr, pStr + dwCount))
//                        return true;
//                }
//            }
//            break;
...
//    }
//
//    if ((*pTempWildPtr != '\0') && (*pTempStrPtr != '\0'))
//    {
//        if (strncmp(pTempWildPtr, "**", 2) == 0)
//            return true;
//        else
//            return false;
//    }
//
//    return (*pTempWildPtr == '\0') && (*pTempStrPtr == '\0');
//}
//
//int main()
//{
